  ...
  return (
    <section className="mx-auto max-w-3xl px-4 py-16">
      <div className="flex flex-col gap-6 rounded-3xl border border-border bg-card p-6 md:flex-row md:items-center">
        {/* TODO: replace /public/images/founder.jpg */}
        <Image
          ...
          onError={(e) => {
            e.currentTarget.src = "/images/founder-placeholder.svg";
          }}
          unoptimized
        />
        <div>
          ...
          <div className="mt-4 flex flex-wrap gap-4 text-sm">
            <a className="underline" href={settings.founderXUrl}>
              X
            </a>
            <a className="underline" href={settings.founderYoutubeUrl}>
              YouTube
            </a>
            <a className="underline" href={`mailto:${settings.founderEmail}`}>
              Email
            </a>
          </div>
        </div>
